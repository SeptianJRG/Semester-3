...
_0x0:
	.DB  0x44,0x61,0x74,0x61,0x3A,0x20,0x0,0x25
	.DB  0x64,0x0,0xA,0x4D,0x61,0x6C,0x61,0x6D
	.DB  0x20,0x48,0x61,0x72,0x69,0x0,0xA,0x53
	.DB  0x69,0x61,0x6E,0x67,0x20,0x48,0x61,0x72
	.DB  0x69,0x0
_0x2020003:
	.DB  0x80,0xC0
...
; .FEND
;
;unsigned char xstring[3],data_cahaya;
;
;void main(void)
; 0000 0038 {
_main:
...
; 0000 0095 // ADC Clock frequency: 750,000 kHz
...
; 0000 009A ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(32)
	OUT  0x7,R30
; 0000 009B ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (1<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	LDI  R30,LOW(132)
	OUT  0x6,R30
...
; 0000 00A9 // RS - PORTB Bit 0
; 0000 00AA // RD - PORTB Bit 1
; 0000 00AB // EN - PORTB Bit 2
; 0000 00AC // D4 - PORTB Bit 4
; 0000 00AD // D5 - PORTB Bit 5
; 0000 00AE // D6 - PORTB Bit 6
; 0000 00AF // D7 - PORTB Bit 7
...
; 0000 00B6       lcd_clear();
	CALL _lcd_clear
; 0000 00B7         lcd_putsf("Data: ");
	__POINTW2FN _0x0,0
	CALL _lcd_putsf
; 0000 00B8         data_cahaya = read_adc(1);
	LDI  R26,LOW(1)
	RCALL _read_adc
	MOV  R5,R30
; 0000 00B9         sprintf(xstring,"%d",data_cahaya);
	...
	CALL _sprintf
	ADIW R28,8
; 0000 00BA         lcd_puts(xstring);
	LDI  R26,LOW(_xstring)
	LDI  R27,HIGH(_xstring)
	CALL _lcd_puts
; 0000 00BB 
; 0000 00BC         if(data_cahaya>100){
	LDI  R30,LOW(100)
	CP   R30,R5
	BRSH _0x9
; 0000 00BD         lcd_putsf("\nMalam Hari");
