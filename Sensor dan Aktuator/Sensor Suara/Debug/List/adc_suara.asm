...
_0x0:
	.DB  0x44,0x61,0x74,0x61,0x20,0x53,0x75,0x61
	.DB  0x72,0x61,0x3A,0x20,0x0,0x25,0x64,0x0
_0x2020003:
	.DB  0x80,0xC0
...
; .FEND
;
;unsigned char xstring[3], data_suara;
;
;void main(void)
; 0000 0038 {
_main:
...
; 0000 00B6       lcd_clear();
	CALL _lcd_clear
; 0000 00B7         lcd_putsf("Data Suara: ");
	__POINTW2FN _0x0,0
	CALL _lcd_putsf
; 0000 00B8         data_suara = read_adc(2);
	LDI  R26,LOW(2)
	RCALL _read_adc
	MOV  R5,R30
; 0000 00B9         sprintf(xstring,"%d", data_suara);
